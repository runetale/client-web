...
export const GetConnectionStatusResponse: MessageFns<GetConnectionStatusResponse> = {
  encode(message: GetConnectionStatusResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GetConnectionStatusResponse {
