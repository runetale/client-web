...
export const NetworkMapResponse: MessageFns<NetworkMapResponse> = {
  encode(message: NetworkMapResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.logToken !== "") {
      writer.uint32(202).string(message.logToken);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 25: {
          ...
          message.logToken = reader.string();
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): NetworkMapResponse {
    return {
      ...
      capabilities: globalThis.Array.isArray(object?.capabilities)
        ...
        : [],
      logToken: isSet(object.logToken)
        ? globalThis.String(object.logToken)
        : isSet(object.log_token)
        ? globalThis.String(object.log_token)
        : "",
    };
  },
  ...
  fromPartial<I extends Exact<DeepPartial<NetworkMapResponse>, I>>(object: I): NetworkMapResponse {
    ...
    message.logToken = object.logToken ?? "";
    return message;
  },
};
