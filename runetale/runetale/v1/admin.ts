...
function createBaseOverview(): Overview {
  return { devicesAmount: 0, usersAmount: 0, fleetsAmount: 0, resourcesAmount: 0 };
}
...
export class OverviewServiceClientImpl implements OverviewService {
  ...
  GetOverview(request: DeepPartial<Empty>, metadata?: grpc.Metadata): Promise<Overview> {
    return this.rpc.unary(OverviewServiceGetOverviewDesc, Empty.fromPartial(request), metadata);
  }
}

export const OverviewServiceDesc = { serviceName: "protos.OverviewService" };
